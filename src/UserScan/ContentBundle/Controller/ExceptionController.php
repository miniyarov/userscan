...
class ExceptionController extends ContainerAware
{
    ...
    protected function findTemplate($templating, $format, $code, $debug)
    {
        ...
        if (!$debug) {
            $template = new TemplateReference('ContentBundle', 'Exception', $name.$code, $format, 'twig');
        ...
        $template = new TemplateReference('ContentBundle', 'Exception', $name, $format, 'twig');
        if ($templating->exists($template)) {
            return $template;
        }
        ...
        return new TemplateReference('ContentBundle', 'Exception', $name, 'html', 'twig');
    }
}
